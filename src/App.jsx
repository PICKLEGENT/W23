                ...
                <div className='left-content'>
                    ...
                    <div className='temp'>
                        <div className='cur-temp'>
                            <div className='tempature'>
                                ...
                                />
                                {data.list ? (
                                    <p>{data.list[0].main.temp}&deg;</p>
                                ) : null}
                            </div>
                            <div className='coords-time'>
                                {data.city ? (
                                    <span>{data.city.coord.lat}&deg;</span>
                                ) : null}
                                {data.city ? (
                                    <span>{data.city.coord.lon}&deg;</span>
                                ) : null}
                            </div>
                        </div>
                    ...
                    <div className='wind-humiditi'>
                        <div className='wind'>
                            {data.list ? (
                                <p>
                                    Скорость ветра {data.list[0].wind.speed}{' '}
                                    км/ч
                                </p>
                            ) : null}
                        </div>
                        ...
                        <div className='weather-forecast'>
                            ...
                            <div className='forecast'>
                                <div className='forecast-description'>
                                    {data.list ? (
                                        <h1>{data.list[0].weather[0].main}</h1>
                                    ) : null}
                                    {data.list ? (
                                        <span>
                                            {
                                    ...
                                    <div className='future-weater__item'>
                                        ...
                                        <div className='weather-icon'>
                                            <img
                                                src={
                                                    data.list
                                                        ? `https://openweathermap.org/img/wn/${data.list[5].weather[0].icon}@2x.png`
                                                        : null
                                                }
                                            />
                                        </div>
                                    ...
                                    <div className='future-weater__item'>
                                        ...
                                        <div className='weather-icon'>
                                            <img
                                                src={
                                                    data.list
                                                        ? `https://openweathermap.org/img/wn/${data.list[6].weather[0].icon}@2x.png`
                                                        : null
                                                }
                                            />
                                        </div>
